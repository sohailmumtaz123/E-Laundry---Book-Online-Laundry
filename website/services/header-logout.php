...
<body>
    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar nav">
        <ul>
          ...
          <!--<li><a href="../about.php" id="two">About</a></li>-->
          ...
          <li id="login"><a href="../schedule-pickup">Book Now</a></li>
        </ul>
  ...
  <!-- Script for active menu color--> 
    ...
    if ( title == "Services-Laundry Services" | title == "Carpet Cleaning - Services" | title == "Curtains Cleaning - Services" | title == "Dry Cleaning - Services" | title == "Laundry Services" | title == "Steam Iron - Services") {
