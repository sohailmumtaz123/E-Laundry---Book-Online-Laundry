        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-img">
                <img src="../assets/img/carpet1.jpg" alt="" class="img-fluid">
              </div>
              ...
              <div class="entry-content">
                <p>
                  Getting your carpet cleaned is cost-effective and produces extremely satisfying results just above your expectations. With our carpet cleaning services, we don’t just aim to remove the dirt, we believe in deep cleansing, so it looks just like a new carpet. We have utilized some of the modern methods of carpet cleaning, which includes carpet shampooing to remove all sorts of dirt, stains and sand. We have specialized cleaners and tools which help the carpet remain intact.
                </p>
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item categories">
                <ul>
                  ...
                  <li class="active"><a href="carpet-cleaning.php">Carpet Cleaning</a></li>
